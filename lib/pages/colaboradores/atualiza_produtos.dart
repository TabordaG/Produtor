...
class Atualiza_Produto_Colaborador extends StatefulWidget {
  final id_sessao;
  final id_produto;
  final id_colaborador;

  Atualiza_Produto_Colaborador(
      {this.id_sessao, this.id_produto, this.id_colaborador});

  @override
  _Atualiza_ProdutoState createState() => _Atualiza_ProdutoState();
}

class _Atualiza_ProdutoState extends State<Atualiza_Produto_Colaborador> {
