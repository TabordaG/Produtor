...
class EstoqueSaidaColaborador extends StatefulWidget {
  final id_sessao;
  final id_colaborador;

  EstoqueSaidaColaborador({
    this.id_sessao,this.id_colaborador,
  });

  @override
  _EstoqueSaidaColaboradorState createState() => _EstoqueSaidaColaboradorState();
}

class _EstoqueSaidaColaboradorState extends State<EstoqueSaidaColaborador> {
