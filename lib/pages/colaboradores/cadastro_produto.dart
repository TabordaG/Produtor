import 'dart:io';
import 'package:produtor/pages/colaboradores/atualiza_produtos.dart';
...
class cadastroProdutoColaborador extends StatefulWidget {
  final id_sessao;
  final id_colaborador;

  cadastroProdutoColaborador({
    this.id_sessao,
    this.id_colaborador,
  });

  @override
  _cadastroProdutoColaboradorState createState() =>
      _cadastroProdutoColaboradorState();
}

class _cadastroProdutoColaboradorState
    extends State<cadastroProdutoColaborador> {
                                      ...
                                      child: Material(
                                        child: Padding(
                                          ...
                                          child: ListTile(
                                            ...
                                            expands: true,
                                            controller:
                                                _descricao_completaTextController,
                                            decoration: InputDecoration(
                                                ...
                                                child: ListTile(
                                                  ...
                                                  onTap: () {
                                                    ...
                                                    Navigator.of(context).push(
                                                      ...
                                                      builder: (context) =>
                                                          new Atualiza_Produto_Colaborador(
                                                        id_sessao:
                                                            widget.id_sessao,
                                                        id_colaborador: widget
                                                            .id_colaborador,
  ...
  Future<String> busca_produto() async {
    ...
    if (resx1.body.length > 2) {
      if (resx1.statusCode == 200) {
        ...
        String link = Basicos.codifica(
            "${Basicos.ip}/crud/?crud=consul107.${widget.id_sessao},${listx[0]['observacoes'].toString()},%${_buscaTextController.text.substring(0, _buscaTextController.text.length - 1)}%,"); // retirar caracter em branco no final
        print("${listx[0]['observacoes'].toString()},");
        var res1 = await http
            .get(Uri.encodeFull(link), headers: {"Accept": "application/json"});
