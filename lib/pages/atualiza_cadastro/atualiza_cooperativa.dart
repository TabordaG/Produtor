...
class Dados_Cadastrais_cooperativa extends StatefulWidget {
  final id_sessao;

  @override
  _Dados_Cadastrais_cooperativaState createState() =>
      _Dados_Cadastrais_cooperativaState();

  Dados_Cadastrais_cooperativa({
    this.id_sessao,
  });
}

class _Dados_Cadastrais_cooperativaState
    extends State<Dados_Cadastrais_cooperativa> {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: InkWell(
            ...
            child: Text('Atualiza Cooperativa'),
          ),
          actions: <Widget>[
//            new IconButton(
//              icon: Icon(
